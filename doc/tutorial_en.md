...
The Codis source code needs to be downloaded to `$GOPATH/src/github.com/feixiao/codis`：
...
```bash
$ cd $GOPATH/src/github.com/feixiao/codis
$ make
...
2017/04/08 16:12:13 main.go:115: [WARN] set assets = /home/codis/go/src/github.com/feixiao/codis/admin/../bin/assets
...
For Java users, you can use a modified Jedis, [Jodis](https://github.com/feixiao/jodis). It will watch the ZooKeeper to get the real-time available proxies, then query via them using a round robin policy to balance load and detect proxy online and offline automatically.
If asynchronous request is required, you can use [Nedis](https://github.com/feixiao/nedis) which is implemented based on Netty.
